.class Lorg/microg/nlp/api/GeocoderBackend$Stub$Proxy;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lorg/microg/nlp/api/GeocoderBackend$Stub;
.end annotation
...
.method constructor <init>(Landroid/os/IBinder;)V
    ...
    .line 147
    iput-object p1, p0, Lorg/microg/nlp/api/GeocoderBackend$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public asBinder()Landroid/os/IBinder;
    ...
    .prologue
    .line 151
    iget-object v0, p0, Lorg/microg/nlp/api/GeocoderBackend$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public close()V
    ...
    :try_start_0
    const-string v2, "org.microg.nlp.api.GeocoderBackend"

    invoke-virtual {v0, v2}, Landroid/os/Parcel;->writeInterfaceToken(Ljava/lang/String;)V

    .line 222
    iget-object v2, p0, Lorg/microg/nlp/api/GeocoderBackend$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public getAboutIntent()Landroid/content/Intent;
    ...
    .line 281
    iget-object v3, p0, Lorg/microg/nlp/api/GeocoderBackend$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public getFromLocation(DDILjava/lang/String;)Ljava/util/List;
    ...
    .line 187
    .local v2, "_result":Ljava/util/List;, "Ljava/util/List<Landroid/location/Address;>;"
    invoke-virtual {v1}, Landroid/os/Parcel;->recycle()V
    ...
    .line 187
    .end local v2    # "_result":Ljava/util/List;, "Ljava/util/List<Landroid/location/Address;>;"
    :catchall_0
    move-exception v3
...
.method public getFromLocationName(Ljava/lang/String;IDDDDLjava/lang/String;)Ljava/util/List;
    ...
    :try_start_0
    const-string v5, "org.microg.nlp.api.GeocoderBackend"
    ...
    .line 206
    iget-object v5, p0, Lorg/microg/nlp/api/GeocoderBackend$Stub$Proxy;->mRemote:Landroid/os/IBinder;
    ...
    invoke-virtual {v3, v5}, Landroid/os/Parcel;->createTypedArrayList(Landroid/os/Parcelable$Creator;)Ljava/util/ArrayList;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 211
    .local v4, "_result":Ljava/util/List;, "Ljava/util/List<Landroid/location/Address;>;"
    ...
    .line 211
    .end local v4    # "_result":Ljava/util/List;, "Ljava/util/List<Landroid/location/Address;>;"
    :catchall_0
    move-exception v5
