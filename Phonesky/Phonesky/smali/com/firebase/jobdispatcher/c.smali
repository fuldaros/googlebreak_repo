.class public final Lcom/firebase/jobdispatcher/c;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 2
    iput-object p1, p0, Lcom/firebase/jobdispatcher/c;->a:Landroid/content/Context;
...
.method private static a(Ljava/util/List;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 13
    invoke-static {p1}, Lcom/firebase/jobdispatcher/c;->a(Ljava/lang/String;)Ljava/util/List;
...
.method private static a(ZLjava/util/List;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 17
    invoke-static {p1, p2}, Lcom/firebase/jobdispatcher/c;->a(Ljava/util/List;Ljava/lang/String;)Ljava/util/List;
...
.method public final a(Lcom/firebase/jobdispatcher/aa;)Ljava/util/List;
    ...
    .line 20
    sget-object v4, Lcom/firebase/jobdispatcher/ao;->a:Lcom/firebase/jobdispatcher/aj;

    if-eq v0, v4, :cond_2

    instance-of v4, v0, Lcom/firebase/jobdispatcher/ai;
    ...
    invoke-static {v0}, Lcom/firebase/jobdispatcher/c;->a(Ljava/lang/String;)Ljava/util/List;

    move-result-object v0

    .line 23
    :goto_0
    invoke-static {v1, v0}, Lcom/firebase/jobdispatcher/c;->a(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    .line 29
    iget v6, v0, Lcom/firebase/jobdispatcher/am;->c:I

    .line 32
    iget v7, v0, Lcom/firebase/jobdispatcher/am;->d:I
    ...
    .line 35
    invoke-static {v0, v1, v5}, Lcom/firebase/jobdispatcher/c;->a(ZLjava/util/List;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 37
    invoke-static {v0, v5, v8}, Lcom/firebase/jobdispatcher/c;->a(ZLjava/util/List;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 39
    invoke-static {v0, v5, v7}, Lcom/firebase/jobdispatcher/c;->a(ZLjava/util/List;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {v0, v5, v6}, Lcom/firebase/jobdispatcher/c;->a(ZLjava/util/List;Ljava/lang/String;)Ljava/util/List;

    move-result-object v0

    .line 41
    invoke-static {v4, v0}, Lcom/firebase/jobdispatcher/c;->a(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    sget-object v5, Lcom/firebase/jobdispatcher/ao;->a:Lcom/firebase/jobdispatcher/aj;
    ...
    invoke-static {v0, v4}, Lcom/firebase/jobdispatcher/c;->a(Ljava/util/List;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 58
    invoke-static {v4}, Lcom/firebase/jobdispatcher/c;->a(Ljava/lang/String;)Ljava/util/List;

    move-result-object v4

    .line 60
    :goto_5
    invoke-static {v0, v4}, Lcom/firebase/jobdispatcher/c;->a(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    .line 73
    :goto_7
    invoke-static {v4, v0}, Lcom/firebase/jobdispatcher/c;->a(Ljava/util/List;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 76
    :cond_b
    invoke-static {v6, v4}, Lcom/firebase/jobdispatcher/c;->a(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {v2}, Lcom/firebase/jobdispatcher/c;->a(Ljava/lang/String;)Ljava/util/List;

    move-result-object v2

    .line 83
    :goto_a
    invoke-static {v0, v2}, Lcom/firebase/jobdispatcher/c;->a(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    .line 104
    :goto_b
    invoke-static {v2, v1}, Lcom/firebase/jobdispatcher/c;->a(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    .line 87
    :cond_f
    iget-object v0, p0, Lcom/firebase/jobdispatcher/c;->a:Landroid/content/Context;
    ...
    .line 93
    iget-object v6, p0, Lcom/firebase/jobdispatcher/c;->a:Landroid/content/Context;
    ...
    const-string v0, "Couldn\'t find a registered service with the name "
