...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .prologue
    .line 1
    invoke-direct {p0, p1}, Landroid/support/v7/widget/dx;-><init>(Landroid/content/Context;)V
...
.method protected onLayout(ZIIII)V
    ...
    .line 117
    invoke-virtual {p0}, Landroid/support/v7/widget/dx;->getGravity()I
    ...
    .line 126
    :goto_0
    invoke-virtual {p0}, Landroid/support/v7/widget/dx;->getDividerDrawable()Landroid/graphics/drawable/Drawable;
    ...
    .line 136
    iget v2, v0, Landroid/support/v7/widget/dy;->h:I
    ...
    .line 140
    :cond_0
    sget-object v13, Landroid/support/v4/view/ai;->a:Landroid/support/v4/view/at;

    invoke-virtual {v13, p0}, Landroid/support/v4/view/at;->k(Landroid/view/View;)I

    move-result v13

    .line 142
    invoke-static {v2, v13}, Landroid/support/v4/view/n;->a(II)I
    ...
    .line 148
    iget v2, v0, Landroid/support/v7/widget/dy;->leftMargin:I

    add-int/2addr v2, v6

    .line 149
    :goto_3
    invoke-virtual {p0, v5}, Landroid/support/v7/widget/dx;->hasDividerBeforeChildAt(I)Z
    ...
    .line 151
    :cond_1
    iget v13, v0, Landroid/support/v7/widget/dy;->topMargin:I
    ...
    iget v13, v0, Landroid/support/v7/widget/dy;->leftMargin:I

    add-int/2addr v2, v13

    iget v13, v0, Landroid/support/v7/widget/dy;->rightMargin:I
...
.method protected onMeasure(II)V
    ...
    .line 14
    sget v6, Landroid/support/v7/a/f;->topPanel:I
    ...
    .line 16
    :cond_0
    sget v6, Landroid/support/v7/a/f;->buttonPanel:I
    ...
    .line 18
    :cond_1
    sget v6, Landroid/support/v7/a/f;->contentPanel:I

    if-eq v5, v6, :cond_2

    sget v6, Landroid/support/v7/a/f;->customPanel:I
    ...
    invoke-virtual {v3, v0}, Landroid/support/v4/view/at;->g(Landroid/view/View;)I
    ...
    .line 102
    iget v9, v6, Landroid/support/v7/widget/dy;->height:I
    ...
    .line 105
    iput v9, v6, Landroid/support/v7/widget/dy;->height:I
