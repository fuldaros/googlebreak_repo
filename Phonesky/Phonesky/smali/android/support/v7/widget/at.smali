...
.method constructor <init>(Landroid/widget/SeekBar;)V
    ...
    .line 1
    invoke-direct {p0, p1}, Landroid/support/v7/widget/aq;-><init>(Landroid/widget/ProgressBar;)V

    .line 2
    iput-object v1, p0, Landroid/support/v7/widget/at;->f:Landroid/content/res/ColorStateList;

    .line 3
    iput-object v1, p0, Landroid/support/v7/widget/at;->g:Landroid/graphics/PorterDuff$Mode;

    .line 4
    iput-boolean v0, p0, Landroid/support/v7/widget/at;->h:Z

    .line 5
    iput-boolean v0, p0, Landroid/support/v7/widget/at;->i:Z

    .line 6
    iput-object p1, p0, Landroid/support/v7/widget/at;->d:Landroid/widget/SeekBar;
...
.method private final a()V
    ...
    .prologue
    .line 37
    iget-object v0, p0, Landroid/support/v7/widget/at;->e:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/at;->e:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/at;->f:Landroid/content/res/ColorStateList;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/at;->g:Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/at;->d:Landroid/widget/SeekBar;
...
.method final a(Landroid/util/AttributeSet;I)V
    ...
    .line 8
    invoke-super {p0, p1, p2}, Landroid/support/v7/widget/aq;->a(Landroid/util/AttributeSet;I)V

    .line 9
    iget-object v0, p0, Landroid/support/v7/widget/at;->d:Landroid/widget/SeekBar;
    ...
    .line 12
    iget-object v2, p0, Landroid/support/v7/widget/at;->d:Landroid/widget/SeekBar;
    ...
    .line 15
    iget-object v2, p0, Landroid/support/v7/widget/at;->e:Landroid/graphics/drawable/Drawable;
    ...
    .line 17
    :cond_1
    iput-object v1, p0, Landroid/support/v7/widget/at;->e:Landroid/graphics/drawable/Drawable;
    ...
    .line 25
    :cond_2
    invoke-direct {p0}, Landroid/support/v7/widget/at;->a()V
    ...
    invoke-virtual {v0, v1, v2}, Landroid/support/v7/widget/ia;->a(II)I

    move-result v1

    iget-object v2, p0, Landroid/support/v7/widget/at;->g:Landroid/graphics/PorterDuff$Mode;
    ...
    .line 29
    iput-boolean v4, p0, Landroid/support/v7/widget/at;->i:Z
    ...
    .line 32
    iput-boolean v4, p0, Landroid/support/v7/widget/at;->h:Z
