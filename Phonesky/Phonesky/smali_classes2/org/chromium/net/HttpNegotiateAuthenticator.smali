...
.method getNextAuthToken(JLjava/lang/String;Ljava/lang/String;Z)V
    ...
    .line 5
    sget-object v9, Lorg/chromium/base/g;->a:Landroid/content/Context;

    .line 7
    new-instance v10, Lorg/chromium/net/v;

    invoke-direct {v10}, Lorg/chromium/net/v;-><init>()V
    ...
    iput-object v2, v10, Lorg/chromium/net/v;->d:Ljava/lang/String;
    ...
    iput-object v2, v10, Lorg/chromium/net/v;->b:Landroid/accounts/AccountManager;

    .line 10
    iput-wide p1, v10, Lorg/chromium/net/v;->a:J
    ...
    iput-object v2, v10, Lorg/chromium/net/v;->c:Landroid/os/Bundle;

    .line 13
    if-eqz p4, :cond_0

    .line 14
    iget-object v2, v10, Lorg/chromium/net/v;->c:Landroid/os/Bundle;
    ...
    invoke-static {v2, v3, v4}, Lorg/chromium/base/n;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    .line 24
    iget-wide v2, v10, Lorg/chromium/net/v;->a:J
    ...
    .line 26
    :cond_2
    iget-object v2, v10, Lorg/chromium/net/v;->b:Landroid/accounts/AccountManager;

    iget-object v3, p0, Lorg/chromium/net/HttpNegotiateAuthenticator;->b:Ljava/lang/String;

    new-instance v4, Lorg/chromium/net/s;

    invoke-direct {v4, p0, v10}, Lorg/chromium/net/s;-><init>(Lorg/chromium/net/HttpNegotiateAuthenticator;Lorg/chromium/net/v;)V
    ...
    invoke-static {v3, v5, v4}, Lorg/chromium/base/n;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    iget-object v4, v10, Lorg/chromium/net/v;->d:Ljava/lang/String;

    iget-object v8, v10, Lorg/chromium/net/v;->c:Landroid/os/Bundle;

    new-instance v9, Lorg/chromium/net/t;

    invoke-direct {v9, p0, v10}, Lorg/chromium/net/t;-><init>(Lorg/chromium/net/HttpNegotiateAuthenticator;Lorg/chromium/net/v;)V
