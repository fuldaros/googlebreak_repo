...
.method public static createBuilder(Ljava/util/EnumSet;)Lcom/squareup/leakcanary/ExcludedRefs$Builder;
    ...
    .line 9
    iget-boolean v1, v0, Lcom/squareup/leakcanary/AndroidExcludedRefs;->applies:Z

    if-eqz v1, :cond_0

    .line 10
    invoke-virtual {v0, v2}, Lcom/squareup/leakcanary/AndroidExcludedRefs;->add(Lcom/squareup/leakcanary/ExcludedRefs$Builder;)V

    move-object v1, v2

    .line 11
    check-cast v1, Lcom/squareup/leakcanary/ExcludedRefs$BuilderWithParams;

    invoke-virtual {v0}, Lcom/squareup/leakcanary/AndroidExcludedRefs;->name()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {v1, v0}, Lcom/squareup/leakcanary/ExcludedRefs$BuilderWithParams;->named(Ljava/lang/String;)Lcom/squareup/leakcanary/ExcludedRefs$BuilderWithParams;
